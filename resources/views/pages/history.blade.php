                            ...
                            <tbody>
                                @forelse($historyItems as $index => $item)
                                    ...
                                    <tr>
                                        ...
                                        <td class="text-end">{{ number_format($item['jumlah_item_datang'] ?? 0, 0, ',', '.') }}
                                        </td>
                                        <td>
                                        ...
                                        <div class="modal-dialog">
                                            <div class="modal-content">
                                                ...
                                                <form action="{{ route('history.update', $item['id'] ?? '') }}" method="POST"
                                                    class="edit-history-form" data-item-id="{{ $item['id'] }}">
                                                    @csrf
                                                    @method('PUT')
                                                    <div class="modal-body">
                                                        ...
                                                        <div class="mb-3">
                                                            ...
                                                            <input type="text" class="form-control edit-supplier-name"
                                                                name="supplier_name" value="{{ $item['supplier_name'] ?? '' }}">
                                                        </div>
                                                        <div class="mb-3">
                                                            <label class="form-label">Sched. receipt qty.</label>
                                                            <input type="number" class="form-control edit-scheduled-receipt-qty"
                                                        ...
                                                        <div class="mb-3">
                                                            ...
                                                            <input type="number" class="form-control edit-jumlah-item-datang"
                                                                name="jumlah_item_datang"
                                                                value="{{ $item['jumlah_item_datang'] ?? 0 }}" min="0" required>
                                                        </div>
                                                        <div class="mb-3">
